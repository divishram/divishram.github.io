$(document).ready(function () {
  ...
  function startGame() {
    ...
    $("#burgerDish").click(function () {
      $(this).hide();
      playerScore += 5;
      clickAudio.play();
    });
    $("#icecreamDish").click(function () {
      $(this).hide();
      playerScore += 5;
      clickAudio.play();
    });
    $("#steakDish").click(function () {
      $(this).hide();
      playerScore += 10;
      clickAudio.play();
    });
    $("#ramenDish").click(function () {
      $(this).hide();
      playerScore += 10;
      clickAudio.play();
    });
    $("#friesDish").click(function () {
      $(this).hide();
      playerScore += 10;
      clickAudio.play();
    });
    $("#cocoDish").click(function () {
      $(this).hide();
      playerScore += 15;
      clickAudio.play();
    });
    $("#dumplinDish").click(function () {
      $(this).hide();
      playerScore += 15;
      clickAudio.play();
    });
    $("#sushiDish").click(function () {
      $(this).hide();
      playerScore += 15;
      clickAudio.play();
    });
    $("#cheeseDish").click(function () {
      $(this).hide();
      playerScore += 15;
      clickAudio.play();
    });
      ...
      $("#gameTitle").show(function () {
        clearScore = setInterval(() => {
          if (playerScore < 20000) {
            ...
            $("#howTo").text(
              "Congradulations, You've won a free three course dinner!! Score: " +
                playerScore
            );
          }
        }, 10);
